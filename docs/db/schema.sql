...
create unique index coach_profiles_stripe_customer_id_idx on public.coach_profiles(stripe_customer_id);
create unique index coach_profiles_stripe_subscription_id_idx on public.coach_profiles(stripe_subscription_id);
...
create index premium_grants_starts_at_idx on public.premium_grants(starts_at);
