...
create table public.trace_points (
  id uuid primary key default gen_random_uuid(),
...
create index trace_points_trace_idx on public.trace_points(trace_id, idx);
...
create index aid_stations_trace_id_idx on public.aid_stations(trace_id);
