...
- Keep the shared card's multi-format helper optional: hide it in the recurring Courses list to reduce card density, while onboarding can retain it where format choice still needs explanation.
