...
- Raising the access-tab autocomplete listboxes above adjacent cards is presentation-only and has no effect on pack selection, entitlements, payments, or invoices.
