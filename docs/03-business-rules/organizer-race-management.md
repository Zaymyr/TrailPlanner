...
- Keep masked formats absent from runner discovery but present in the authorized Organizer workspace. Their grey navigation treatment and explicit public-visibility label are status cues, not a relaxation of the runner access gate.
