...
- L'action `Importer les informations` accepte la sélection de plusieurs PDF/images dans l'interface. L'extraction PDF texte conserve le numéro de page lorsque le parseur le fournit. Les images et PDF sans texte nécessitent encore un OCR ; aucune donnée n'est inventée en son absence.
