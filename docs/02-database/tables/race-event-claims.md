...
- The website-import review remains inside that approved-only dashboard boundary. Its viewport-contained scrolling and expandable field-confidence recap change only review accessibility and do not weaken the membership checks on preview or apply; the quality score is never proof of organizer access.
