...
- The full-height mobile RaceBook loader and its animated runner/sponsor panels are presentation-only; they do not change the event read, visibility gate, or `organizer_details` contract.
