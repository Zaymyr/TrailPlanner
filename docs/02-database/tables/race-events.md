...
- RaceBook exits dismiss to the existing Courses route instead of reopening a previously viewed format. This route-stack behavior does not change event visibility, ownership, or publication state.
