...
- Bulk publication with an already-active Essential, Complete, or Signature entitlement also bypasses checkout and never creates or consults an edition-request row; out-of-tier drafts remain private.
