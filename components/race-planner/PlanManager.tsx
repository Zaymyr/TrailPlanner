                  ...
                  {filteredPlans.length === 0 ? (
                    ...
                    <div className="max-h-72 space-y-3 overflow-y-auto pr-2">
                      {filteredPlans.map((plan) => (
                        <div
                          key={plan.id}
                          className="rounded-lg border border-border bg-card px-3 py-2 shadow-sm dark:border-slate-800 dark:bg-slate-900/60"
                        >
                          <p className="break-words text-sm font-semibold text-foreground dark:text-slate-50">
                            {plan.name}
                          </p>
                          <p className="mb-2 text-xs text-muted-foreground dark:text-slate-400">
                          ...
                          <div className="flex gap-2">
                            ...
                            <Button
                              variant="ghost"
                              className="h-7 flex-1 px-2 text-xs text-red-300 hover:text-red-200"
