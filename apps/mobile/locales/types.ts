...
export type MobileTranslations = {
  ...
  catalog: {
    ...
    racebookSectionEventInfo: string;
    ...
    racebookFieldEventName: string;
    racebookFieldEventLocation: string;
    racebookFieldEventStartDate: string;
    racebookFieldEventEndDate: string;
