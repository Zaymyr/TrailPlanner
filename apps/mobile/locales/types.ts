...
export type MobileTranslations = {
  ...
  plans: {
    ...
    guestModeBannerBody: string;
    guestModeBannerCta: string;
    unlockButton: string;
  ...
  trainingLive: {
    ...
    notificationsSettingsCta: string;
    liveKicker: string;
    nextIntake: string;
    liveLevels: string;
    upcoming: string;
  ...
  onboarding: {
    ...
    nutritionLoadingError: string;
    nutritionEmptyTitle: string;
    nutritionEmptySubtitle: string;
    notificationsTitle: string;
    ...
    notificationsDemoPlanCta: string;
    completionTitle: string;
    completionSubtitle: string;
    completionSummaryTitle: string;
    completionRaceLine: string;
    completionFilledLine: string;
    completionEmptyLine: string;
    completionEditLine: string;
  ...
  catalog: {
    ...
    racebookTabGear: string;
    racebookTabBib: string;
    racebookTabCourse: string;
    racebookTabAccess: string;
    racebookSectionSchedule: string;
    ...
    racebookSectionGearRecommended: string;
    racebookSectionGearConditional: string;
    racebookSectionAdditionalInfo: string;
    racebookServiceSupporters: string;
    racebookServiceAccommodations: string;
    racebookServiceRestaurants: string;
    racebookServiceRecovery: string;
    racebookServicePartners: string;
    ...
    racebookParticipationRelay: string;
    racebookParticipationSoloAndRelay: string;
    racebookRelayLeg: string;
    racebookRelayHandoverTime: string;
    racebookFieldStartLocation: string;
    racebookFieldFinishLocation: string;
    racebookFieldFinishCutoff: string;
