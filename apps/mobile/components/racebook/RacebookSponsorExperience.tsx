...
const styles = StyleSheet.create({
  ...
  sponsorSurface: { gap: 8, paddingVertical: 4 },
  sponsorSurfaceHeading: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  sponsorSurfaceEyebrow: { color: Colors.textSecondary, fontSize: 12, fontWeight: '800', letterSpacing: 0.45, textTransform: 'uppercase' },
  sponsorSurfaceRule: { flex: 1, height: 1, backgroundColor: Colors.border },
  sponsorGrid: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: -3 },
  sponsorGridItem: { width: '50%', padding: 3 },
  serviceSponsorList: { gap: 6 },
  sponsorPressable: { borderRadius: 12 },
  sponsorPressed: { opacity: 0.65 },
  sponsorCard: { minHeight: 60, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', gap: 10, borderRadius: 12, borderWidth: 1, borderColor: Colors.border, backgroundColor: Colors.surface, paddingHorizontal: 10, paddingVertical: 8 },
  sponsorCardOfficial: { minHeight: 56, gap: 8, paddingHorizontal: 8, paddingVertical: 7 },
  sponsorCardPrincipal: { minHeight: 72, backgroundColor: Colors.brandLight },
  sponsorCardService: { minHeight: 58 },
  sponsorLogo: { width: 38, height: 38 },
  sponsorLogoOfficial: { width: 30, height: 30 },
  sponsorLogoPrincipal: { width: 48, height: 48 },
  sponsorLogoService: { width: 36, height: 36 },
  sponsorCopy: { flex: 1, minWidth: 0, alignItems: 'flex-start', gap: 1 },
  sponsorCopyOfficial: { gap: 0 },
  sponsorName: { color: Colors.textPrimary, fontSize: 13, fontWeight: '800' },
  sponsorNameOfficial: { fontSize: 11, lineHeight: 14 },
  sponsorCategory: { color: Colors.textSecondary, fontSize: 11 },
  sponsorCategoryOfficial: { fontSize: 9, lineHeight: 12 },
  discoverRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 3 },
  discoverLabel: { color: Colors.brandPrimary, fontSize: 11, fontWeight: '800' },
});
