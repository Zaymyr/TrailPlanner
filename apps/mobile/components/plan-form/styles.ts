...
export const styles = StyleSheet.create({
  ...
  highlightsHeader: { marginBottom: 12 },
  highlightsSubtitle: { color: Colors.textSecondary, fontSize: 13, lineHeight: 18 },
  highlightsGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 10,
  ...
  highlightValue: { color: Colors.brandPrimary, fontSize: 22, fontWeight: '800' },
  highlightLabel: { color: Colors.textPrimary, fontSize: 13, fontWeight: '700', marginTop: 4 },
  highlightMeta: { color: Colors.textSecondary, fontSize: 12, marginTop: 3 },
  highlightBreakdownSection: { marginTop: 14 },
  ...
  highlightEmptyText: { color: Colors.textMuted, fontSize: 13, fontStyle: 'italic', marginTop: 14 },
  ...
  sectionAccordionHeaderSpaced: { marginTop: 24 },
