...
export function PlanSaveBar({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-40 px-4 pb-4 sm:px-6">
      <div className="pointer-events-auto mx-auto flex w-full max-w-5xl flex-col gap-3 rounded-xl border border-amber-300/40 bg-card/95 p-3 shadow-2xl backdrop-blur dark:border-amber-500/40 dark:bg-slate-950/90 sm:flex-row sm:items-center sm:justify-between sm:p-4">
