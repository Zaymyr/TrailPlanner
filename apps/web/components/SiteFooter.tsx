    ...
    <footer className="border-t border-border pt-4 text-xs text-muted-foreground sm:pt-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex flex-wrap items-center gap-x-4 gap-y-2">
          <Link className="transition hover:text-[hsl(var(--success))] dark:hover:text-emerald-200" href={"/courses" as Route}>
            {isEnglishPath ? "Races" : "Courses"}
          </Link>
          <Link
          ...
          <Link className="transition hover:text-[hsl(var(--success))] dark:hover:text-emerald-200" href={"/organisateurs" as Route}>
            Organisateurs
          </Link>
          <Link className="transition hover:text-[hsl(var(--success))] dark:hover:text-emerald-200" href={"/a-propos" as Route}>
            À propos
          </Link>
          <Link className="transition hover:text-[hsl(var(--success))] dark:hover:text-emerald-200" href={"/methodologie" as Route}>
            Méthodologie
          </Link>
        </nav>
      </div>
