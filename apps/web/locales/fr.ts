...
export const fr: Translations = {
  ...
  admin: {
    ...
    socialTemplates: {
      ...
      poster: {
        ...
        hookBody: "Un visuel clair pour donner envie de swiper, comprendre la course vite, puis retenir la strategie nutrition.",
        ...
        macroBody: "Distance, denivele, temps prevu et allure moyenne: tout ce qu'il faut voir avant d'entrer dans le detail.",
        ...
        noAidStations: "Aucun ravito detaille sur ce plan pour le moment.",
        ...
        ctaTitle: "CTA",
        ctaSlideTitle: "Prêt a partager, pret a convertir",
        ctaSlideBody: "La derniere slide doit donner envie de passer a l'action, sans surcharger le message.",
  ...
  profile: {
    ...
    basics: {
      ...
      utmbIndexHelper: "Optionnel. Renseignez votre cote UTMB si vous la connaissez.",
