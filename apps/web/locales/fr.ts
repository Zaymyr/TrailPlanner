...
export const fr: Translations = {
  ...
  partners: {
    ...
    hero: {
      ...
      subtitle:
        "L'application de planification trail qui intègre les produits réels des marques de nutrition. Données validées, lien sortant vers votre site, intégration officielle.",
      ctaPrimary: "Référencer mes produits",
      ctaSecondary: "Voir l'application",
    },
    why: {
      title: "Pourquoi rejoindre Pace Yourself",
      pillar1Title: "Visibilité ciblée",
      pillar1Description:
        "Chaque produit listé renvoie vers votre site via un lien sortant tracké. Trafic 100% qualifié de coureurs en phase de planification de course.",
      pillar2Title: "Données validées",
      pillar2Description:
        "Vos produits sont référencés à partir des données que vous nous fournissez. Pas de scraping, pas d'approximations, pas d'informations obsolètes.",
      pillar3Title: "Contrôle de l'image",
      pillar3Description:
        "Vous validez le nom, la description et le visuel utilisés. Vous gardez la main sur votre identité de marque dans l'app.",
    },
    appearance: {
    ...
    process: {
      ...
      step1Title: "Vous nous envoyez vos données",
      step1Description:
        "Un fichier nutritionnel, une fiche technique ou un simple PDF. Pas besoin de format particulier.",
      step2Title: "On intègre vos produits",
      step2Description: "Intégration soignée avec validation finale de la fiche avec vous avant publication.",
      step3Title: "Vos produits sont accessibles aux coureurs",
      step3Description:
        "Disponibles dans le catalogue, intégrables à n'importe quel plan de course, avec lien direct vers votre site.",
    },
    requirements: {
      title: "Les informations dont nous avons besoin",
      items: [
        "Nom du produit",
        "Type (gel, boisson, barre, électrolyte…)",
        "Glucides par portion (g)",
        "Sodium par portion (mg)",
        "Caféine si applicable (mg)",
        "Lien vers la page produit officielle",
        "Visuel produit (uniquement avec votre accord écrit)",
      ],
      reassurance:
        "Aucun engagement contractuel. Aucune exclusivité demandée. Vous pouvez retirer vos produits à tout moment sur simple demande.",
    },
    about: {
      title: "Derrière Pace Yourself",
      paragraph1:
        "Je m'appelle Faustin Bertrand. J'ai lancé Pace Yourself parce que j'en avais marre de gérer mes plans de course dans des tableurs Excel branlants.",
      paragraph2:
        "Trail runner moi-même, j'ai terminé le Marathon du Mont-Blanc en 9h12 et je prépare actuellement l'UTMB 80k de Saint-Jacques. C'est cette expérience terrain qui guide les choix produit de l'app : ce qui marche vraiment en course, pas ce qui marche en théorie.",
      paragraph3:
        "Pace Yourself est en phase de lancement, avec ses premiers utilisateurs Premium. Construire un catalogue produit fiable et validé par les marques, c'est ma priorité avant de scaler.",
      photoAlt: "Faustin Bertrand en trail",
    },
    brands: {
      title: "Ils nous font confiance",
      emptyState: "Section bientôt remplie. Soyez l'une des premières marques à rejoindre Pace Yourself.",
    },
    faq: {
      title: "Questions fréquentes",
      q1Question: "Combien ça coûte ?",
      q1Answer:
        "Le référencement est gratuit. Pace Yourself génère son revenu via les abonnements Premium des coureurs, pas via les marques.",
      q2Question: "Y a-t-il un engagement contractuel ?",
      q2Answer:
        "Aucun. Un simple accord par email suffit. Vous pouvez demander le retrait de vos produits à tout moment.",
      q3Question: "Quels formats de données acceptez-vous ?",
      q3Answer:
        "PDF, Excel, CSV, ou simple email avec les informations. On s'adapte à ce qui est le plus simple pour vous.",
      q4Question: "Mes produits seront-ils mis en avant ou simplement listés ?",
      q4Answer:
        "Listés équitablement dans le catalogue. Aucune mise en avant payante. Les algorithmes de plan recommandent les produits qui correspondent le mieux aux objectifs nutritionnels du coureur.",
    },
    finalCta: {
      title: "Prêt à rejoindre Pace Yourself ?",
      subtitle: "Référencement gratuit, sans engagement.",
      button: "Référencer mes produits",
    },
  },
  links: {
    meta: {
      title: "Pace Yourself — Tous les liens",
    ...
    cards: {
      ...
      contact: {
        title: "Contact",
        subtitle: "Me contacter directement",
      },
    },
    footer: {
  ...
  admin: {
    ...
    products: {
      ...
      import: {
        ...
        description: "Colle une liste JSON de produits sportifs pour remplacer proprement le catalogue partag?.",
        sharedOnlyNote: "Seuls les produits partagés sont archivés. Les produits créés par les utilisateurs ne sont pas modifiés.",
        ...
        archiveSharedLabel: "Archiver le catalogue partag? existant avant import",
        loadExample: "Charger un exemple",
        submit: "Importer le catalogue",
        submitting: "Import en cours...",
        invalidJson: "Le JSON coll? est invalide ou ne contient pas de produits.",
        success: "{count} produits importés dans le catalogue partagé.",
      },
      messages: {
    ...
    users: {
      ...
      details: {
        ...
        signInCount: "Nb connexions :",
        activityWindow: "Période d'activité :",
        planCount: "Nb plans :",
        latestPlan: "Dernier plan :",
        favoriteProducts: "Produits favoris :",
        onboarding: "Onboarding complété :",
        completed: "Oui",
        notCompleted: "Non",
    ...
    socialTemplates: {
      ...
      loadTemplateError: "Impossible de charger le template social.",
      exportError: "Impossible d'exporter les slides en PNG.",
      emptyPlans: "Aucun plan enregistré disponible pour cet admin.",
      planLabel: "Plan source",
      planPlaceholder: "Choisir un plan",
      refreshPlans: "Rafraîchir les plans",
      refreshingPlans: "Rafraîchissement...",
      refreshPreview: "Régénérer l'aperçu",
      refreshingPreview: "Chargement...",
      exportPng: "Exporter les 4 PNG",
      exporting: "Export des PNG...",
      selectionTitle: "Plan sélectionné",
      updatedAt: "Mis à jour le {date}",
      previewTitle: "Aperçu HTML",
      previewDescription:
        "Le visuel est généré depuis le payload standardisé du plan et peut servir de base pour les futurs templates HTML, PDF ou carrousels.",
      scrollHint: "Fais défiler horizontalement pour parcourir les slides du carrousel.",
      slideProgress: "Slide {current} / {total}",
      loadingPreview: "Génération du template en cours...",
      previewEmpty: "Aucun aperçu disponible pour ce plan.",
      noPlanSelected: "Choisis un plan pour générer le template.",
      poster: {
        eyebrow: "Social race plan",
        slideLabels: {
          hook: "Hook",
          macro: "Course",
          nutrition: "Nutrition",
        ...
        fallbackBadge: "Mode estimation",
        hookTitle: "Le plan course en 4 slides.",
        hookBody: "Un visuel clair pour donner envie de swiper, comprendre la course vite, puis retenir la stratégie nutrition.",
        hookScrollCta: "Swipe pour voir la course, les ravitos et le CTA final.",
        hookTeaseCta: "Une fin claire pour convertir ou partager.",
        macroTitle: "Les infos macro de la course",
        macroBody: "Distance, dénivelé, temps prévu et allure moyenne : tout ce qu'il faut voir avant d'entrer dans le détail.",
        distanceLabel: "Distance",
        elevationLabel: "D+",
        targetTimeLabel: "Temps cible",
        avgPaceLabel: "Allure moyenne",
        nutritionTitle: "Mes cibles nutritionnelles",
        nutritionBody: "Les reperes horaires d'abord, puis ce qu'il faut reprendre aux ravitos clefs.",
        keyAidStationsTitle: "Ce que je recupere au ravito",
        noAidStations: "Aucun ravito détaillé sur ce plan pour le moment.",
        perHourTitle: "Besoins moyens / h",
        totalTitle: "Besoins totaux",
        carbsLabel: "Glucides",
        waterLabel: "Eau",
        sodiumLabel: "Sodium",
        carbsShort: "glucides",
        ...
        sodiumShort: "sodium",
        quantity: "× {count}",
        startCarryTitle: "À emporter au départ",
        estimateBadge: "Estimé",
        noDetails: "Détails à confirmer",
        assumptionsTitle: "Hypothèses",
        disclaimerTitle: "Disclaimer",
        aidStationsTitle: "Résumé ravitos",
        aidStationsSubtitle: "Ce qu'il faut reprendre à chaque point de passage.",
        stationMeta: "Km {km} • ETA {eta}",
        durationLabel: "Temps total {value}",
        moreItems: "+ {count} éléments supplémentaires",
        moreAidStations: "+ {count} ravitos à intégrer dans une future version carrousel",
        ctaTitle: "CTA",
        ctaSlideTitle: "Prêt à partager, prêt à convertir",
        ctaSlideBody: "La dernière slide doit donner envie de passer à l'action, sans surcharger le message.",
        schemaTitle: "Template",
      },
    },
    raceCatalog: {
      title: "Catalogue de courses",
      ...
      noGpxWaypoints: "Aucun ravito détecté dans le GPX : ajoutez-les rapidement ci-dessous.",
      ...
      errors: {
        ...
        traceDeTrailAuthFailed: "Impossible de se connecter à Trace de Trail avec ces identifiants.",
        ...
        aidStationsUpdateFailed: "Impossible de mettre à jour les ravitos.",
      },
    },
    growth: {
  ...
  profile: {
    ...
    basics: {
      ...
      utmbIndexHelper: "Optionnel. Renseignez votre côte UTMB si vous la connaissez.",
      comfortableFlatPaceLabel: "Allure confortable sur plat",
      comfortableFlatPaceHelper: "Utilisée comme allure de base par défaut lors de la création d'un plan.",
