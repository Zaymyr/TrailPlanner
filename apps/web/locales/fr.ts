    ...
    onboarding: {
      ...
      steps: [
        ...
        },
        {
          title: "Enregistrer votre plan",
          description:
            "Créez un compte gratuit pour sauvegarder plusieurs plans, les recharger à tout moment et débloquer les fonctionnalités premium comme le remplissage auto et les fiches de course imprimables.",
        },
      ],
      improve: {
        nutritionMix: {
