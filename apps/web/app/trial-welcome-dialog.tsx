...
const TRIAL_COPY = {
  ...
  introFr: "Merci d'avoir cree votre compte. Vous avez acces pendant 15 jours aux fonctions Premium :",
...
export function TrialWelcomeDialog() {
  ...
  useEffect(() => {
    ...
    const shouldShowTrial = Boolean(trialQuery.data?.trialStartedAt && !trialQuery.data?.trialWelcomeSeenAt);
      ...
      <div className="w-full max-w-lg space-y-4 rounded-lg border border-emerald-300/30 bg-card p-6 text-foreground shadow-2xl dark:bg-slate-950">
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-foreground">Francais</p>
