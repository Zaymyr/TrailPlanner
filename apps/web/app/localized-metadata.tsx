...
import { buildLocaleMetaCopy, CANONICAL_URL, localeToOgLocale, SITE_URL } from "./seo";
...
export function LocalizedMetadata() {
  ...
  React.useEffect(() => {
    ...
    const homeMeta = pathname === "/" ? buildLocaleMetaCopy(locale) : undefined;
    ...
    if (!routeMeta && !supportMeta && !homeMeta) {
      return;
    }

    const localizedTitle = supportMeta?.title ?? routeMeta?.title ?? homeMeta?.title;
    const description = supportMeta?.description ?? routeMeta?.description ?? homeMeta?.description;
