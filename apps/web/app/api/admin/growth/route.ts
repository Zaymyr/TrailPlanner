...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const [usersRaw, plansRaw, subscriptionsRaw, membershipsRaw, eventsRaw, editionsRaw, racesRaw] = await Promise.all([
    ...
    const newOrganizers = new Set(activeMemberships
    ...
    const response = {
      ...
      trend: buildTrend(range.start, range.end, users, plans, activatedUserIds),
      organizers: {
        newOrganizers,
