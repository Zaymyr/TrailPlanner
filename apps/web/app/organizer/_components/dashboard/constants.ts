...
export const EVENT_MODULE_IDS: OrganizerModuleId[] = ["event", "equipment", "bibPickup", "access", "services", "branding", "sponsors"];
export const FORMAT_MODULE_IDS: OrganizerModuleId[] = ["formats", "equipment", "bibPickup", "access", "aidStations", "awards"];
