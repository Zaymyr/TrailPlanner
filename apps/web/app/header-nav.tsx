...
const activeClass =
  "border border-brand-border bg-brand-surface text-brand shadow-sm hover:bg-brand-surface dark:border-emerald-400/70 dark:bg-emerald-950/40 dark:text-emerald-50 dark:hover:bg-emerald-950/60";
