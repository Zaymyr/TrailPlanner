-- Treat a profile as completed only when onboarding has captured hydration bag capacity.
-- A user_profiles row can now be created automatically for premium trials.
