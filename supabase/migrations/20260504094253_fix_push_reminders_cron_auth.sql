...
revoke all on function public.is_valid_push_cron_secret(text) from public, anon, authenticated;
grant execute on function public.is_valid_push_cron_secret(text) to service_role;
