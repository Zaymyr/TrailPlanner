...
export const en: Translations = {
  ...
  trace: {
    ...
    error: "Unable to load traces.",
    myTraces: "My traces",
    publicTraces: "Public traces",
    noMyTraces: "No personal traces yet.",
    noPublicTraces: "No public traces available.",
    ownerYou: "You",
    ownerLabel: "Owner",
    publicBadge: "Public",
    ...
    drawerOpen: "Open traces",
    drawerClose: "Close",
    map: {
      addPoints: "Add route points",
      addAidStations: "Place aid stations",
      undo: "Undo point",
      clear: "Clear all",
      routing: "Routing…",
      hint: "Click to add points. Switch to “Place aid stations” to mark aid stops.",
    },
    form: {
      nameLabel: "Trace name",
      namePlaceholder: "Morning loop",
      publicToggle: "Make trace public",
      statsLabel: "{points} points • {aid} aid stations",
      save: "Save trace",
      saving: "Saving…",
      downloadGpx: "Download GPX",
      copyGpx: "Copy GPX",
      validationMissing: "Add a name and at least one point to save.",
    },
    statuses: {
      saved: "Trace saved successfully.",
      duplicated: "Trace duplicated.",
      deleted: "Trace deleted.",
      copied: "GPX copied to clipboard.",
      downloaded: "GPX downloaded.",
      missingSession: "Missing session.",
      loadFailed: "Unable to load trace.",
      duplicateFailed: "Unable to duplicate trace.",
      deleteFailed: "Unable to delete trace.",
      gpxError: "Unable to export GPX.",
      routingError: "Unable to request routing. Added direct point instead.",
    },
  },
  auth: {
    shared: {
