...
export const fr: Translations = {
  ...
  trace: {
    title: "Traces",
    newTrace: "Nouvelle trace",
    searchPlaceholder: "Rechercher des traces",
    loading: "Chargement des traces…",
    error: "Impossible de charger les traces.",
    myTraces: "Mes traces",
    publicTraces: "Traces publiques",
    noMyTraces: "Aucune trace personnelle.",
    noPublicTraces: "Aucune trace publique disponible.",
    ownerYou: "Vous",
    ...
    drawerOpen: "Ouvrir les traces",
    drawerClose: "Fermer",
    map: {
      addPoints: "Ajouter des points",
      addAidStations: "Placer des ravitaillements",
      undo: "Annuler le dernier point",
      clear: "Tout effacer",
      routing: "Calcul de l'itinéraire…",
      hint: "Cliquez pour ajouter des points. Passez en mode « Placer des ravitaillements » pour les marquer.",
    },
    form: {
      nameLabel: "Nom de la trace",
      namePlaceholder: "Boucle du matin",
      publicToggle: "Rendre la trace publique",
      statsLabel: "{points} points • {aid} ravitaillements",
      save: "Enregistrer la trace",
      saving: "Enregistrement…",
      downloadGpx: "Télécharger GPX",
      copyGpx: "Copier GPX",
      validationMissing: "Ajoutez un nom et au moins un point pour enregistrer.",
    },
    statuses: {
      saved: "Trace enregistrée.",
      duplicated: "Trace dupliquée.",
      deleted: "Trace supprimée.",
      copied: "GPX copié dans le presse-papiers.",
      downloaded: "GPX téléchargé.",
      missingSession: "Session manquante.",
      loadFailed: "Impossible de charger la trace.",
      duplicateFailed: "Impossible de dupliquer la trace.",
      deleteFailed: "Impossible de supprimer la trace.",
      gpxError: "Impossible d'exporter le GPX.",
      routingError: "Impossible d'appeler le routage. Point direct ajouté.",
    },
  },
  auth: {
    shared: {
